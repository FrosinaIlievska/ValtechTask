...
import * as showMenuMobile from "./AdditionalFunctions.js";
  ...
  return (
    <div>
      <header class="App-header">
        ...
        {/* MOBILE MENU */}
        <i class="fa fa-bars icon mobile" onClick={showMenuMobile}></i>
      ...
      <main>
          <section id="section1">
            ...
            <div class="transbox">
              ...
              <button class="sec1-button">CONTACT</button>
              </a>
          ...
          <section id="section3">
            <div class="flexbox">
              ...
              <div class="art-body">
                <h1>Teaser Title</h1>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc enim ligula, auctor rhoncus massa non, congue dignissim sapien. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae</p>
              </div>
            ...
            <div class="flexbox">
              ...
              <div class="art-body">
                <h1>Teaser Title</h1>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc enim ligula, auctor rhoncus massa non, congue dignissim sapien.</p>
              </div>
                <button class="art-button">Read more</button>
              </article>
              ...
              <div class="art-body">
                <h1>Teaser Title</h1>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc enim ligula, auctor rhoncus massa non, congue dignissim sapien. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae <br/><br/>Vestibulum ante ipsum…</p>
              </div>
                <button class="art-button">Read more</button>
              </article>
            </div>
      ...
      <footer class="App-footer">
        <div class="footer__headline">
          <div><img src={logo} class="footer-logo" alt="logo" /></div>
        </div>
        <div>
